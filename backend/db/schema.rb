...
puts "募集（求人）データを作成中..."
# 今回は user ではなく CompanyProfile の ID で紐付けるため、プロフィールを変数に格納します
...
jobs_data = [
  {
    company_profile_id: plex2_profile.id,
  ...
  {
    company_profile_id: tech_profile.id,
  ...
  {
    company_profile_id: design_profile.id,
