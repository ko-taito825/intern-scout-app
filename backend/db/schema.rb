...
ActiveRecord::Schema[8.1].define(version: 2026_06_08_083557) do
  ...
  create_table "entries", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["job_id", "user_id"], name: "index_entries_on_job_id_and_user_id", unique: true
  ...
  create_table "messages", force: :cascade do |t|
    t.text "body"
    t.datetime "created_at", null: false
    t.boolean "is_from_company", default: false
    t.boolean "is_read", default: false, null: false
  ...
  create_table "scouts", force: :cascade do |t|
    ...
    t.string "status"
    t.datetime "updated_at", null: false
    t.index ["company_user_id", "intern_user_id"], name: "index_scouts_on_company_user_id_and_intern_user_id", unique: true
